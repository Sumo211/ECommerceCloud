jQuery(document).ready(function($) {
    ...
    // add into table
    $(document).on( 'click', '.clothes a.compare:not(.added)', function(e){
        e.preventDefault();
    ...
    $(document).on('click', '.clothes a.compare.added', function (ev) {
        ev.preventDefault();
