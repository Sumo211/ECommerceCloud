...
public class Category extends TableImpl<CategoryRecord> {
    ...
    private static final long serialVersionUID = -969662781;

    /**
     * The reference instance of <code>ecm_product.category</code>
     */
    ...
    /**
     * The column <code>ecm_product.category.id</code>.
     */
    public final TableField<CategoryRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>ecm_product.category.description</code>.
     */
    public final TableField<CategoryRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>ecm_product.category.name</code>.
     */
    ...
    /**
     * Create a <code>ecm_product.category</code> table reference
     */
    public Category() {
        this("category", null);
    }
    ...
    /**
     * Create an aliased <code>ecm_product.category</code> table reference
     */
    ...
    public List<UniqueKey<CategoryRecord>> getKeys() {
        return Arrays.<UniqueKey<CategoryRecord>>asList(Keys.KEY_CATEGORY_PRIMARY, Keys.KEY_CATEGORY_UK_46CCWNSI9409T36LURVTYLJAK);
    }
